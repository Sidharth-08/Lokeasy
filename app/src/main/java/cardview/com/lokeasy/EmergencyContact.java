...
public class EmergencyContact extends ContentProvider {

    static final String PROVIDER_NAME = "cardview.com.lokeasy";
    ...
    static final String DATABASE_NAME = "EmergencyContact";
    static final String CONTACTS_TABLE_NAME = "EmergencyContact";
