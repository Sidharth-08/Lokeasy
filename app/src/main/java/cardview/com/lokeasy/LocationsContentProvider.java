...
public class LocationsContentProvider extends ContentProvider{
    ...
    public static final String PROVIDER_NAME = "cardview.com.lokeasy.locations";
    ...
    public int deleteitem(Uri uri, Double lat, Double lng, String[] selectionArgs) {
        int cnt = 0;
        //cnt = mLocationsDB.deleteTitle(lat,lng);
        return cnt;
    }
